import { getDatabase } from "@/backend/db/mongodb";
import { User, UserResponse } from "@/backend/modals/User.modal";
import bcrypt from "bcryptjs";
import { ObjectId } from "mongodb";

export const loginUser = async (identifier: string, password: string): Promise<UserResponse> => {
